...
export default function Footer() {
  return (
      ...
      <footer className="w-full bottom-0 left-0 right-0 bg-yellow-400 border-t-4 border-black shadow-[0_-5px_0_0_#000000] p-8 relative z-20">
    <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 text-black">
      ...
      <div className="space-y-2">
        ...
        <a 
          ...
          className="text-sm text-lime-800 underline block font-mono hover:text-lime-600 transition"
        >
